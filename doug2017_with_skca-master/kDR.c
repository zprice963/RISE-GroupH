...
#define dt _nt->_dt
#define gkDRbar _p[0]
#define vhalfkDRAct _p[1]
#define slopekDRAct _p[2]
#define vhalfkDRTAct _p[3]
#define slopekDRTAct _p[4]
#define ik _p[5]
#define ikDR _p[6]
#define ninf _p[7]
#define tau_n _p[8]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kDR C:/Users/zprice11/Desktop/doug2017_with_skca-master/kDR.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Non-inactivating potassium delayed rectifier current (kDR-current)";
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   double _lninf , _ltau_n ;
 _lninf = 1.0 / ( 1.0 + exp ( - ( v - vhalfkDRAct ) / slopekDRAct ) ) ;
   _ltau_n = 95.2 * ( 1.0 / ( 1.0 + exp ( - ( v - vhalfkDRTAct ) / slopekDRTAct ) ) ) ;
   Dn = ( _lninf - n ) / _ltau_n ;
   }
 return _reset;
}
