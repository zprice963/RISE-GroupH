...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 cagk C:/Users/zprice11/Desktop/doug2017_with_skca-master/CaBK.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "CaBK.mod";
static const char* nmodl_file_text = 
  "TITLE CaGk\n"
  ...
  "	celsius		(degC)\n"
  "	v		(mV)\n"
  "	gkbar=.001	(mho/cm2)	: Maximum Permeability\n"
  "	cai = 5.e-5	(mM)\n"
  "	ek		(mV)\n"
  "\n"
  "	d1 = .84\n"
