...
#define slopeAct _p[2]
#define vhalfTact _p[3]
#define slopeTact _p[4]
#define ik _p[5]
#define minf _p[6]
#define tau_m _p[7]
#define m _p[8]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kM C:/Users/zprice11/Desktop/doug2017_with_skca-master/M.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "a low-voltage activated, non-inactivating, potassium current (M-current)";
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   double _lminf , _ltau_m ;
 _lminf = 1.0 / ( 1.0 + exp ( - ( v - vhalfAct ) / slopeAct ) ) ;
   _ltau_m = 50.0 + 48.0 / ( 1.0 + exp ( - ( v - vhalfTact ) / slopeTact ) ) ;
   Dm = ( _lminf - m ) / _ltau_m ;
   }
 return _reset;
}
...
double boltz ( _threadargsprotocomma_ double _lv , double _ly , double _lz ) {
   double _lboltz;
 _lboltz = 1.0 / ( 1.0 + exp ( - ( _lv - _ly ) / _lz ) ) ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "M.mod";
static const char* nmodl_file_text = 
